...
func (ec *executionContext) _Mutation_createMeetup(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNMeetup2ᚖgithubᚗcomᚋalexNgariᚋmeetmeupᚋgraphᚋmodelsᚐMeetup(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNMeetup2ᚕᚖgithubᚗcomᚋalexNgariᚋmeetmeupᚋgraphᚋmodelsᚐMeetupᚄ(ctx context.Context, sel ast.SelectionSet, v []*models.Meetup) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNMeetup2ᚖgithubᚗcomᚋalexNgariᚋmeetmeupᚋgraphᚋmodelsᚐMeetup(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNMeetup2ᚖgithubᚗcomᚋalexNgariᚋmeetmeupᚋgraphᚋmodelsᚐMeetup(ctx context.Context, sel ast.SelectionSet, v *models.Meetup) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalNUser2githubᚗcomᚋalexNgariᚋmeetmeupᚋgraphᚋmodelsᚐUser(ctx context.Context, sel ast.SelectionSet, v models.User) graphql.Marshaler {
	return ec._User(ctx, sel, &v)
}

func (ec *executionContext) marshalNUser2ᚖgithubᚗcomᚋalexNgariᚋmeetmeupᚋgraphᚋmodelsᚐUser(ctx context.Context, sel ast.SelectionSet, v *models.User) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
